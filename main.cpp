        ...
        for (int i = 0; i < objects->size(); i++) {
            ...
            if (objects->at(i)->getId() == LASER_OBJ && !hit) {
                ...
                if (dx * dx + dy * dy <= 2500) {
                    ...
                    Physical* wreck1 = new Physical("images/ufofragL.point", CMAGENTA, PHYSICAL_OBJ, -10, -10);
                    wreck1->scale(4);
                    ...
                    Physical* wreck2 = new Physical("images/ufofragR.point", CMAGENTA, PHYSICAL_OBJ, 10, -10);
                    wreck2->scale(4);
